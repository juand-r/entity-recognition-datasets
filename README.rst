...
Ritter          Twitter            None                 Ritter et al., 2011             `No split <https://github.com/aritter/twitter_nlp/blob/master/data/annotated/ner.txt>`_ , `Train/test split <http://kimi.ml.cmu.edu/transfer/data.tar.gz>`_
